...
public class SharePreferenceUtils {
    private static String mName = "datas";
     ...
     * @param val
     */
    public static boolean putString(Context context, String key, String val) {
        return put(context, key, val);
    }


    public static boolean putList(Context context, String key, List<String> value){

        String valuestr = new Gson().toJson(value);
        return putString(context,key,valuestr);
    ...
    private static boolean put(Context context, String key, Object object) {
        if (mEditor == null) {
            setEditor(context);
        }
