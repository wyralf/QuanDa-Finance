...
import com.tome.modulebase.Image.ImageUtil;
import com.tome.modulebase.Image.config.SingleConfig;
import com.tome.modulebase.Image.config.AnimationMode;
import com.tome.modulebase.Image.config.GlobalConfig;
import com.tome.modulebase.Image.config.PriorityMode;
import com.tome.modulebase.Image.config.ScaleMode;
import com.tome.modulebase.Image.config.ShapeMode;
...
public class GlideLoader implements ILoader {
    ...
    public void saveImageIntoGallery(DownLoadImageService downLoadImageService) {
        ThreadUtils.runOnBackgroundThread(downLoadImageService);
    }
